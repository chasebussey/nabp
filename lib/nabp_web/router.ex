defmodule NabpWeb.Router do
  ...
  scope "/", NabpWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{NabpWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", NabpWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{NabpWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", NabpWeb do
    ...
    live_session :current_user,
      on_mount: [{NabpWeb.UserAuth, :mount_current_user}] do
